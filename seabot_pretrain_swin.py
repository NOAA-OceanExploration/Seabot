...
wandb.init(project="seabot", name="drive_pretraining_AWS_large_EX2304_1_swin")
...
def train_loop(start_epoch, start_batch, best_loss, model, optimizer, scheduler, train_loader, val_loader, criterion):
    ...
    for epoch in range(start_epoch, NUM_EPOCHS):
        ...
        for batch_idx, (images, labels) in enumerate(train_loader):
            ...
            optimizer.zero_grad()
            outputs = model(images)  # outputs are directly the final predictions
...
model_name = 'swin_large_patch4_window7_224'  # Choose the appropriate model
